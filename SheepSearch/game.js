...
async function fetchPassageFromAPI(reference) {
    ...
    if (typeof reference === 'string' || reference instanceof String) {
        ...
        if (passageObject.reference && passageObject.passageText && passageObject.contextText) {
          // reference is actualy already a fully formed passageObject. Probably manualy set for debugging. Let's just return it.
          return reference
        }
    }
